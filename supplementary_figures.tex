...
% of its own, so the four supplementary figures live here instead of at the
% end of manuscript.tex. Figure numbering (S1-S4) matches the citations in the
...
\includegraphics[width=0.82\textwidth]{figures/FigS3.pdf}
...
\includegraphics[width=0.92\textwidth]{figures/FigS4.pdf}
